...
export class LanguageSelectComponent implements OnInit, OnDestroy {
  ...
  /**
   * Recibe los valores de las opciones y la opción inicial e inicializa los valores necesarios
   */
  ngOnInit() {
  ...
  protected filterOptions() {
    ...
    this.filteredOptions.next(
      this.dropdownOptions.filter(currentOption => this.languageService.instant(currentOption['name']).toLowerCase()
      .includes(search))
    );
  }
