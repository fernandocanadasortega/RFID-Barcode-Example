...
import com.uk.tsl.tid.devicelist.R;
...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button settingBtn = findViewById(R.id.settings_btn);
    ...
    void checkListViewState() {
        Boolean isVisible = mReaders.list().isEmpty() ? false : true;

        findViewById(R.id.empty_list_view_message).setVisibility( isVisible ? View.GONE : View.VISIBLE);
        findViewById(R.id.image_bluetooth).setVisibility(isVisible ? View.GONE : View.VISIBLE);
        findViewById(R.id.image_reader).setVisibility(isVisible ? View.GONE : View.VISIBLE);
        findViewById(R.id.settings_btn).setVisibility(isVisible ? View.GONE : View.VISIBLE);
    }

    void goBluetoothSettings() {
